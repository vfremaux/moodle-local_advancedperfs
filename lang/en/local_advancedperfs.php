...
$string['configdevdebuglevel'] = 'Developers debug level';
$string['configdevdebuglevel_desc'] = 'Set the debug level is the current users matches the developer\'s account list.';
$string['configdevusers'] = 'Developers users';
$string['configdevusers_desc'] = 'Coma separated list of user account ids that are part of developer team.';
$string['configfilelogging'] = 'Enable file Logging';
$string['configmaxtracefilesize'] = 'Max size for trace file';
$string['configmaxtracefilesize_desc'] = 'If limit is set, the trace file will be flushed out when comming over the limit.';
...
$string['configtrace'] = 'Trace to';
$string['configtrace_desc'] = 'Location for trace out if enabled. Web server should have write access to this file. Usually defined in config.php as \$CFG->dataroot.\'/trace.log\'. the meta %DATAROOT%/trace.log is allowed. If not set, no trace will be output whatever activation state.';
$string['configtraceout'] = 'Trace out';
$string['configtraceout_desc'] = 'If enabled, will trace out all debug_trace() outputs to the trace location.';
$string['content'] = 'Content';
$string['data'] = 'Data';
$string['debug'] = 'Debug';
$string['errors'] = 'Errors';
$string['notices'] = 'Notices';
$string['finedebug'] = 'Fine grain debug';
...
$string['no'] = 'No trace';
$string['notracefile'] = 'No trace file available';
...
$string['settings'] = 'Go to settings';
$string['seetrace'] = 'See the trace file';
$string['since'] = 'Since';
