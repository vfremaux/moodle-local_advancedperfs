...
$string['configdevdebuglevel'] = 'Valeur de déboggage des développeurs';
$string['configdevdebuglevel_desc'] = 'Définit la valeur de déboggage pour les utilisateurs faisant partie de la liste de développeurs.';
$string['configdevusers'] = 'Liste des développeurs';
$string['configdevusers_desc'] = 'Liste des ids (à virgule) des comptes développeurs.';
